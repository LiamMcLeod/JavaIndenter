 ...
 * Indent a Java program read from the
 * standard input.
 * Indented program written to the standard output.
 */
class Main {
  /*
   * This approach only works so far, and there will be cases when it
   * will be difficult to correctly indent some Java code constructs etc.
  ...
  /*
   * Read each source strLine of the program and store in
...
//			blnFlag=false;
  ...
  /*
   * Find the longest source strLine of Java code in
   * the data structure program
   */
  ...
  /*
   * Print the Java program held in program
   * with // comments indented vertical at col position pos
